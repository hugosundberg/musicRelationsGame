  ...
  if (isVisible)
    return (
      <div className={styles.startScreen}>
        <h2>Update</h2>
        <p>
          As of November 2024, Spotify has deprecated the Related Artist API
          ...
          <a href="https://hugosundberg.github.io/hugo/" target="_blank">portfolio website</a> to try out
          my other apps!
        </p>
        <h2>Welcome!</h2>
        <p>
